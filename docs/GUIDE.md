...
- `docs/spec.md` : les spécifications et l'historique du projet
...
docs/
  ...
  spec.md               Les spécifications et historique du projet
  GUIDE.md              Ce fichier
...
## Spécifications du projet (docs/spec.md)

Le fichier `docs/spec.md` contient la mémoire du projet : état actuel, décisions techniques, historique des phases et points à valider.

Quand on modifie le site (via Claude Code ou manuellement), `docs/spec.md` doit être mis à jour avant de clôturer la session. Claude Code le fait automatiquement si on utilise le projet via Claude Code Desktop.
